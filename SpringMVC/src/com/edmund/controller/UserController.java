...
public class UserController {
	...
	public String tohello(){
		System.out.println("我进入了hello方法");
		return "hello";
	}
	@RequestMapping("/mmm")
	public String tommm(){
		System.out.println("我进入了mmm方法");
		return "mmm";
	}
	
	
	@RequestMapping(value="/login",method=RequestMethod.POST)
	public String login(String name,String password,HttpServletRequest request) throws UnsupportedEncodingException{
	...
	public String login1(User2 user,ModelMap map) throws UnsupportedEncodingException{
