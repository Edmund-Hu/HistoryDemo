...
<div style="position:absolute;top:60px;left:170px;width:1094px;height:534px;">
    ...
    <table border="1px white solid" style="width:1090px;border-collapse: collapse">
        ...
        %>
            ...
            <td style="width:6%;font-size:13px;"><input type="checkbox"></td>
            ...
            <td style="width:15%;font-size:13px;"><a class="a" href="http://localhost:8080/BBS_System/Recycle.edmund?method=recover&&id=<%=msg[i].getId() %>">还原</a>|
   ...
   <input type="button" value="全选" style="border:1px white solid;background:rgba(0,0,0,0.3);color:white">
        <input type="button" value="取消" style="border:1px white solid;background:rgba(0,0,0,0.3);color:white">
        <input type="button" value="更新" style="border:1px white solid;background:rgba(0,0,0,0.3);color:white">
        <input type="button" value="审核" style="border:1px white solid;background:rgba(0,0,0,0.3);color:white">
        <input type="button" value="推荐" style="border:1px white solid;background:rgba(0,0,0,0.3);color:white">
        <input type="button" value="移动" style="border:1px white solid;background:rgba(0,0,0,0.3);color:white">
        <input type="button" value="删除" style="border:1px white solid;background:rgba(0,0,0,0.3);color:white">
    </div>
