...
<html>
  <head>
    ...
    <title>My JSP 'DaoHangHome.jsp' starting page</title>
...
<div style="position:absolute;top:60px;left:170px;width:1094px;height:534px;">
    ...
    <span style="font-size:12px;position:absolute;top:5px">欢迎使用留言管理系统!</span>
    ...
    <table  style="position:absolute;top:40px;width:1090px;font-weight:bold;border-collapse: collapse;">
        ...
        <tr>
            <td style="font-size:13px;">公告:本系统将于2016年08月30日进行版本更新v.1.2.09,给您带来的不便、敬请谅解! </td>
        </tr>
    </table>
