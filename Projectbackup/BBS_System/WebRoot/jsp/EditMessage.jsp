...
<form action="SearchMessage.edmund" method="post">
    <table style="width:1090px;border-collapse: collapse;">
        ...
        <tr>
            ...
            <td style="width:80%">
            <input type="hidden" value="<%= msg[0].getId()%>" name="id">
                <textarea cols=60 rows=8 style="border:1px #cccccc solid;outline:none;font-size:16px;" name="contents"><%= msg[0].getMessage()%></textarea>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td style="width:80%;color:white">
                <a href=><input type="reset" value="取消修改" style="border:1px white solid;background:rgba(0,0,0,0.3);float:left"></a>
                <input type="submit" value="确认修改" style="border:1px white solid;background:rgba(0,0,0,0.3);float:left">
            </td>
        </tr>
    </table>
    </form>
