...
*/
    public static String post(String url, List<NameValuePair> nvps) {
        try (CloseableHttpClient client = getHttpClient()) {
            ...
            // nvps.add(new BasicNameValuePair("Param","全文检索:三泰"));
            // nvps.add(new BasicNameValuePair("Index","1"));
            // nvps.add(new BasicNameValuePair("Page","5"));
            ...
            httpost.setHeader("User-Agent", "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/56.0.2924.87 Safari/537.36");
    ...
    protected static final CloseableHttpClient getHttpClient() {
        ...
        hcBuilder.setServiceUnavailableRetryStrategy(new ServiceUnavailableRetryStrategy() {
            private final Set<Integer> serviceUnavailableStatusCodes = new HashSet<>(Arrays.asList(new Integer[]{HttpStatus.SC_INTERNAL_SERVER_ERROR, HttpStatus.SC_BAD_GATEWAY,
            ...
            public boolean retryRequest(HttpResponse response, int executionCount, HttpContext context) {
                return executionCount <= maxRetries && serviceUnavailableStatusCodes.contains(response.getStatusLine().getStatusCode());
            }
    ...
    public static InputStream doGetXls(String requestUrl) {
        BufferedReader in = null;
        try {
            URL url = new URL(requestUrl);
            HttpURLConnection httpConn = (HttpURLConnection) url.openConnection();
    ...
    // String url =
    // "http://wenshu.court.gov.cn/List/ListContent?MmEwMD=1DQ8qHKcAAv68xZUnW37faG28YH5dZqQ4iCNpdCRYMlogalmNn3kwMZvqhfuz3RSCZUS4IczUIP.WvRWJZJPBd0tGtnSkC3dfTQkJ3JVaW0ghhVJdF4N99KzRDUjmTsMWpzhK1VJ5RLlXCrfK_ArHXLtAB9o2x2AFdIhw83cXu5_3lU7sIcg6uSP2s1HEla5JAKt_Qqpw1kGXp1WYagHfdbiuwv07bLsJum6S8v0lGNzSqh4Xp0ffAooQnFjUf86WrNMCAi7.J4tzW2.ahEBIV2OYZ6T2rp.XhbeObvTeLyWR1LQ68d5qh.8sln85qac5D67vW_CXovyeFVtNDnKRNcPgDEYDOm1PSgSCUiFmHPCW";
    ...
    public static void main(String[] args) throws IOException {
        String url = "http://wenshu.court.gov.cn/List/ListContent?MmEwMD=1DQ8qHKcAAv68xZUnW37faG28YH5dZqQ4iCNpdCRYMlogalmNn3kwMZvqhfuz3RSCZUS4IczUIP.WvRWJZJPBd0tGtnSkC3dfTQkJ3JVaW0ghhVJdF4N99KzRDUjmTsMWpzhK1VJ5RLlXCrfK_ArHXLtAB9o2x2AFdIhw83cXu5_3lU7sIcg6uSP2s1HEla5JAKt_Qqpw1kGXp1WYagHfdbiuwv07bLsJum6S8v0lGNzSqh4Xp0ffAooQnFjUf86WrNMCAi7.J4tzW2.ahEBIV2OYZ6T2rp.XhbeObvTeLyWR1LQ68d5qh.8sln85qac5D67vW_CXovyeFVtNDnKRNcPgDEYDOm1PSgSCUiFmHPCW";
        List<NameValuePair> nvps = new ArrayList<NameValuePair>();
        nvps.add(new BasicNameValuePair("Param", "全文检索:三泰"));
        nvps.add(new BasicNameValuePair("Index", "1"));
        nvps.add(new BasicNameValuePair("Page", "5"));
