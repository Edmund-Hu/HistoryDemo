...
<html>
  ...
  <div id="container">
<div id="div1">
<div class="label">参与人员 <%="1+4" %></div> <hr style="width:120px;border:none;border-top:1px solid #555555;" >
  <%--  <% 
...
if(users!=null){
 ...
 <%--    <%Message[] msg=(Message[])request.getAttribute("message"); 
    ...
    <a href="HomePage.edmund?method=showdetail&id=${msg.id }"> <div class="time" id="time1">${msg.username}:${msg.inserttime}</div>
      <div class="content" id="content1">${msg.message}</div></a>
      </c:forEach>
